    ...
    <div className='flex w-full flex-col gap-y-2'>
        {data.map((post, index) => (
            <Card key={index} className={cn('w-full cursor-pointer bg-base-1000', className)}>
                ...
                <CardContent className='space-y-2'>
                    ...
                    <div className='flex items-center justify-between pl-10'>
                        ...
                        <div className='flex items-center gap-2'>
                            ...
                            <Button className='size-10 text-base-400' variant='type2' size='icon'>
                                <BookmarkIcon />
                            </Button>
                        </div>
                    </div>
                        ...
                        ? post.top_comments.map((comment, index) => (
                              <div className='flex flex-col gap-4' key={index}>
                                  <div className='flex space-x-2 rounded-md'>
                                      ...
                                      <div className='flex-1 rounded-md bg-base-100 p-4'>
                ...
                <CardFooter>
                    <Button className='ml-8 text-base-400 hover:text-foreground'>See all 5 comments</Button>
                </CardFooter>
            </Card>
        ))}
    </div>
